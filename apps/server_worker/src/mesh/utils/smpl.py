...
import sys
sys.path.insert(0, osp.join(osp.dirname(__file__), '../../utils/smplpytorch'))
...
class SMPL(object):
    def __init__(self):
        ...
        self.joint_regressor_h36m=np.load(os.path.join(cfg.root_dir, 'config', 'J_regressor_h36m_correct.npy')).astype(np.float32)

...
import apps.dl_worker.app.core.mesh.models as models
from multiple_datasets import MultipleDatasets
from apps.dl_worker.app.core.mesh.core.loss import get_loss
from apps.dl_worker.app.core.mesh.core.config import cfg
...
class Trainer:
    ...
    def train(self, epoch):
        ...
        for i, (inputs, targets, meta) in enumerate(batch_generator):
            ...
            pred_mesh, lift_pose = self.model(gt_reg3dpose)  # B x 12288 x 3
    ...
    def test(self, epoch, current_model=None):
        ...
        with torch.no_grad():
            for i, (inputs, targets, meta) in enumerate(loader):
                ...
                pred_mesh, pred_pose = self.model(gt_pose3d)
                # print(self.val_dataset.mesh_model.face)
                ...
                # vis_3d_pose(pred_pose[0].detach().cpu().numpy(), self.val_dataset.skeleton, joint_set_name='human36')
                # vis_3d_pose(gt_pose3d[0].detach().cpu().numpy(), self.val_dataset.skeleton, joint_set_name='human36')
                if i % self.print_freq == 0:
